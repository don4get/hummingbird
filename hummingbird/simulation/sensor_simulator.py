...
class SensorSimulator(Simulator):
    ...
    def simulate(self):
        while self.sim_time < self.sim_p.end_time:
            ...
            # -------controller-------------
            estimated_state = self.mav.dynamics.true_state  # uses true states in the control
            ...
            self.mav.sensors.update_sensors(self.mav.dynamics.true_state, self.mav.dynamics._forces)  # update the sensors
